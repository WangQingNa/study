package com.soap.common_util.ftp;
...
//			createDir(remotePath);
	...
	private static void diaoyong() {
		SftpUtils ftp = new SftpUtils("192.168.0.51", "test_cleansettle", "Nu43QIHoEQjfyEdRdb6S",22);
		String localPath = "D:\\sign\\contract\\";
		String remotePath = "/contract/12/";
		ftp.connect();

        ftp.createDir(remotePath);
		//ftp.uploadFile(remotePath, "18.pdf", localPath, "18.pdf");
